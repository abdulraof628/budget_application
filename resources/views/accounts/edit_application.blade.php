                                        ...
                                        @if(count($applications) > 0)
                                            @foreach($applications as $key=>$application)
                                                <tr>
                                                    ...
                                                    <td><a href="#edit_application" data-toggle="modal" title="Add or delete items"><i class="fa fa-refresh fa-2x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="#view_application{id}" data-toggle="modal" title="View details"><i class="fa fa-eye fa-2x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="" title="View summary"><i class="fa fa-list fa-2x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
